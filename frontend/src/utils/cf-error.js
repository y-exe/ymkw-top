...
export function getCloudflareErrorHtml(params) {
  let html = params.isOriginIssue ? `<!DOCTYPE html>
    ...
    <div id="cf-error-details" class="p-0">
        <header class="mx-auto pt-10 lg:pt-6 lg:px-8 w-240 lg:w-full mb-8">
            <h1 class="inline-block sm:block sm:mb-2 font-light text-60 lg:text-4xl text-black-dark leading-tight mr-2">
                <span class="inline-block">___TITLE___</span>
                <span class="code-label">Error code ___ERROR_CODE___</span>
            </h1>
            
            
            <div class="">2026-04-06 02:46:35 UTC</div>
        </header>
          ...
          <div class="w-240 lg:w-full mx-auto">
                <div class="clearfix md:px-8">
                    ...
                    <div id="cf-cloudflare-status" class="cf-error-source relative w-1/3 md:w-full py-15 md:p-0 md:py-8 md:text-left md:border-solid md:border-0 md:border-b md:border-gray-400 overflow-hidden float-left md:float-none text-center">
                        ...
                        <span class="md:block w-full truncate">___CF_LOCATION___</span>
                        <h3 class="md:inline-block mt-3 md:mt-0 text-2xl text-gray-600 font-light leading-1.3" >Network</h3>
                    ...
                    <div id="cf-host-status" class=" relative w-1/3 md:w-full py-15 md:p-0 md:py-8 md:text-left md:border-solid md:border-0 md:border-b md:border-gray-400 overflow-hidden float-left md:float-none text-center">
                        ...
                        <span class="md:block w-full truncate">Backend Server</span>
                        <h3 class="md:inline-block mt-3 md:mt-0 text-2xl text-gray-600 font-light leading-1.3" >API</h3>
                        <span class="leading-1.3 text-2xl" style="color: #9bca3e">Working</span>
                    </div>
        ...
        <div class="cf-error-footer cf-wrapper w-240 lg:w-full py-10 sm:py-4 sm:px-8 mx-auto text-center sm:text-left border-solid border-0 border-t border-gray-300">
            <p class="text-13">
                <span class="cf-footer-item sm:block sm:mb-1">Ray ID: <strong class="font-semibold">840F5012368A7254</strong></span>
                ...
                <span class="cf-footer-item sm:block sm:mb-1"><span>Performance &amp; security by</span> <a rel="noopener noreferrer" href="/" id="brand_link" target="_blank">ymkw-top</a></span>
...
<div id="cf-wrapper">
    <div id="cf-error-details" class="p-0">
        ...
        <div class="cf-error-footer cf-wrapper w-240 lg:w-full py-10 sm:py-4 sm:px-8 mx-auto text-center sm:text-left border-solid border-0 border-t border-gray-300">
            <p class="text-13">
                <span class="cf-footer-item sm:block sm:mb-1">Ray ID: <strong class="font-semibold">F029271CE364B93E</strong></span>
                <span class="cf-footer-separator sm:hidden">&bull;</span>
                <span id="cf-footer-item-ip" class="cf-footer-item hidden sm:block sm:mb-1">
                    Your IP:
                    <button type="button" id="cf-footer-ip-reveal" class="cf-footer-ip-reveal-btn">Click to reveal</button>
...
`;
  html = html.replace(/___TITLE___/g, params.title);
  html = html.replace(/___ERROR_CODE___/g, params.errorCode);
  html = html.replace(/___HTML_TITLE___/g, params.htmlTitle);
  html = html.replace(/___CF_LOCATION___/g, params.cfLocation);
  html = html.replace(/___WHAT_HAPPENED___/g, params.whatHappened);
  html = html.replace(/___WHAT_CAN_I_DO___/g, params.whatCanIDo);
  return html;
}
