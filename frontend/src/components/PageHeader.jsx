    ...
    return (
        <div className="relative mb-2 pt-3 animate-in fade-in w-full text-center">
            <a
                ...
                className="fixed right-5 top-[5.25rem] z-40 flex h-16 w-16 items-center justify-center text-black transition-opacity hover:opacity-70 md:right-8 md:top-20 md:h-20 md:w-20"
                aria-label="GitHub Repository"
                title="GitHub Repository"
            >
                <svg viewBox="0 0 24 24" className="h-12 w-12 md:h-16 md:w-16" fill="currentColor" aria-hidden="true">
