    ...
    return (
        <div className="relative mb-2 pt-3 animate-in fade-in w-full text-center">
            <a
                ...
                className="fixed right-5 top-[6.5rem] z-40 flex h-16 w-16 items-center justify-center text-black transition-opacity hover:opacity-70 md:right-8 md:top-20 md:h-14 md:w-14"
                aria-label="GitHub Repository"
                title="GitHub Repository"
            >
                <svg viewBox="0 0 24 24" className="h-12 w-12 md:h-10 md:w-10 rounded-full border-4 border-white shadow-sm" aria-hidden="true">
