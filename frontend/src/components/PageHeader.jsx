    ...
    return (
        <div className="relative mb-2 pt-3 animate-in fade-in w-full text-center">
            <a
                ...
                className="absolute right-0 top-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-[#111111] text-white shadow-sm transition-all hover:-translate-y-0.5 hover:bg-black md:h-14 md:w-14"
